...
# %% RULKOV
rulkov = RulkovCoupled(alpha=4.3, sigma=[0.001, 0.00112], beta=0.001, cells=2, W=0.01, x0=-2, y0=-2.9, N=100000)
# %% Slider Parameters
...
datas = getData()
scale=100
plotting.SliderPlot(datas=datas, step=rulkov.N/scale, zoom=0.8, together=False, extraPars=pars)
# %% Phase Space
